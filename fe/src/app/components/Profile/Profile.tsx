...
class Profile extends React.Component<IProfileProps, any> {
  ...
  public render() {
    ...
    const tabIndex = this.props.location.pathname.match("/favorites") ? 1 : 0;
    return (
  ...
  private handleTabChange = (_event: React.ChangeEvent<{}>, value: any) => {
    if (value === 0) {
      ...
      this.props.history.push(`@${this.props.match.params.username}/favorites`);
    }
  };

  private handleFollowChange = (_event: React.ChangeEvent<{}>) => {
