        ...
        <CardHeader
          avatar={
            article.author && article.author.image ? (
              <Avatar aria-label="user" src={article.author.image} />
            ) : (
          ...
          title={
            article.author && (
              <span onClick={this.gotoProfile}>{article.author.username}</span>
            )
          }
          subheader={
          ...
          action={
            ...
            >
              <FavoritetIcon color={isFavorite ? "secondary" : "primary"} />
              {article.favoritesCount || 0}
            </IconButton>
          }
        />
        <CardContent onClick={this.readMore}>
          <Typography paragraph={true} className="article-preview-title">
            {article.title}
          </Typography>
          <Typography
            paragraph={true}
