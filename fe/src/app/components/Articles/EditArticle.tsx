...
> {
  ...
  public componentWillMount() {
    this.injectedProps.editorStore.setArticleSlug(this.props.match.params.slug);
  }
  ...
  public render() {
    ...
    const { isLoading: isloadingArticle } = this.injectedProps.articlesStore;
    if (isloadingArticle) {
    ...
    return (
      <form onSubmit={this.handleSubmitForm}>
        <Grid container={true} justify="center">
          <Grid item={true} xs={8} md={4} style={{ marginTop: "1rem" }}>
            <CardHeader
              avatar={
                <Avatar
                  sizes="large"
            ...
            />
            <MediumEdtorView />
            <TagChips tags={tagList} onDelete={this.handleDeleteTag} />
            <TextField
              id="tag"
              label="Tag"
